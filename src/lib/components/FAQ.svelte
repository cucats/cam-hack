...
<div class="mx-auto max-w-7xl faq-container" class:visible>
  <h2>FAQ</h2>
  <div class="faq-list">
    ...
    <div class="faq-item" style="animation-delay: 0.05s">
      <FAQuestion>
        {#snippet question()}
    ...
    <div class="faq-item" style="animation-delay: 0.1s">
      <FAQuestion>
        {#snippet question()}
    ...
    <div class="faq-item" style="animation-delay: 0.15s">
      <FAQuestion>
        {#snippet question()}
    ...
    <div class="faq-item" style="animation-delay: 0.2s">
      <FAQuestion>
        {#snippet question()}
    ...
    <div class="faq-item" style="animation-delay: 0.25s">
      <FAQuestion>
        {#snippet question()}
          <span>I don't have a team!</span>
        {/snippet}
        If you don't have a team yet, don't hesitate to look around in our
        <a target="_blank" class="theme-hyperlink" href="/discord">Discord server</a
        >. It's also common to form teams at the event itself!
      </FAQuestion>
    </div>
    <div class="faq-item" style="animation-delay: 0.3s">
      <FAQuestion>
        {#snippet question()}
    ...
    <div class="faq-item" style="animation-delay: 0.35s">
      <FAQuestion>
        {#snippet question()}
    ...
    <div class="faq-item" style="animation-delay: 0.4s">
      <FAQuestion>
        {#snippet question()}
    ...
    <div class="faq-item" style="animation-delay: 0.45s">
      <FAQuestion>
        {#snippet question()}
    ...
    <div class="faq-item" style="animation-delay: 0.5s">
      <FAQuestion>
        {#snippet question()}
    ...
    <div class="faq-item" style="animation-delay: 0.55s">
      <FAQuestion>
        {#snippet question()}
