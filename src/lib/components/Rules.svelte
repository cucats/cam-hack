<div class="mx-auto max-w-7xl rules-container">
  <h2>Rules</h2>
  <div class="rules-content">
    <div class="rule-section">
      <h3>Entry</h3>
      <ul class="list-disc pl-8 rule-list">
        <li class="rule-item">
    ...
    <div class="rule-section">
      ...
      <ul class="list-disc pl-8 rule-list">
        ...
        <li class="rule-item">You must not bring or consume alcohol at the hackathon.</li>
        <li class="rule-item">
