<div class="mx-auto max-w-7xl">
  <h2>About</h2>
  <p>
    Cam Hack is a 32 hour hackathon for the innovative minds at the University
    ...
    plenty of free stash, food, and mini-events throughout this hackathon. Over
    £1000 worth of prizes are to be won!
  </p>
</div>
